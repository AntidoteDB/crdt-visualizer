    ...
    render() {
        return (
            <Group visible={this.props.visible}>
                <Rect x={this.props.x - 60} y={this.props.y + 20} stroke={'white'}
                      fill={'white'}  height={60} width={150}/>
                <Text text={this.props.text} fill={'Grey'}
                      x={this.props.x - 60} y={this.props.y + 20}
                      fontSize={12} fontFamily={'Calibri'}
                      padding={5} align={'center'} width={150}  height={60}/>
                <Text text={this.props.state} fill={'Grey'}
